...
!function (a, b) {
	...
	}, !1), "complete" === e.readyState ? /*e.body.style.fontSize = 12 * i + "px"*/console.warn("readyState") : e.addEventListener("DOMContentLoaded", function () {
		/*e.body.style.fontSize = 12 * i + "px"*/console.warn("DOMContentLoaded");
